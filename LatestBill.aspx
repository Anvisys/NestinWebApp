                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                                        ...
                                        <asp:TemplateField FooterStyle-BorderStyle="None">
                                            <ItemTemplate>
                                                <div class="row layout_shadow_table">
                                                    ...
                                                    <div class="col-xs-4 ">
                                                        Amount:
                                                        <asp:Label ForeColor="Red" ID="Label2" runat="server" Text='<%# Eval("CurrentBillAmount") %>'></asp:Label>
                                                        to be  paid by:
                            ...
                            <div class="container-fluid">
                                <div class="" style="height: 40px;">
                                    <div class="col-sm-2 hidden-xs">
                                        <div>
                                            <label class="pull-left ">Bill Details : </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-9 col-xs-9" style="">
                                        <div class="" style="">
                                            ...
                                            <asp:DropDownList ID="drpGeneratedBillType" runat="server" CssClass="layout_ddl_filter"></asp:DropDownList>
                        ...
                        <asp:View ID="PaymentView" runat="server">
                            ...
                            <table style="width: 70%; margin-left: 15%;">
                                <tr>
                                    <td colspan="2" style="text-align: center; color: #ff6a00; font-family: Arial, Helvetica, sans-serif; font-size: large; height: 10px;">Detail Bill:</td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="height: 10px; border-bottom: 1px solid #d5d3d3;"></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2" style="height: 30px; background-color: #f2f2f2; color: #bfbfbf; padding-left: 3%; font-size: x-large;">Payment Made :
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table id="paymannual" style="width: 70%; margin-left: 15%; text-align: center;">
                                ...
                                <tr>
                                    <td style="width: 40%; text-align: right;">Amount :
                                    </td>
                                    <td style="width: 60%;">
                                ...
                                <tr>
                                    <td style="text-align: right;">Transaction ID:
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="text-align: right;">Invoice ID:
                                    </td>
                                    <td>
                        ...
                        <div class="container-fluid" style="width: 400px;">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <asp:Label Width="100" ID="lblFlatNuber" runat="server" Font-Size="Small"></asp:Label>
                                    <br />

                                    <label class="lbltxt" style="width: 150px;">Cycle Type :</label>

                                    <asp:Label Width="100" ID="lblCycle" runat="server" Font-Size="Small"></asp:Label>
                                    <br />
                                    ...
                                    <asp:Label Width="100" ID="lblFlatArea" runat="server" Font-Size="Small"></asp:Label>
                                    <br />

                                    <label class="lbltxt" style="width: 150px;">Society BillID :</label>
                                    <asp:Label Width="100" ID="lblsocietybillid" runat="server" Font-Size="Small"></asp:Label>
                                    <br />

                                    <label class="lbltxt" style="width: 150px;">Current MonthBalance :</label>
                                    <asp:Label Width="100" ID="lblCurrentmonthbal" runat="server" Font-Size="Small"></asp:Label>
                                    <br />

                                    <label class="lbltxt" style="width: 150px;">Charge Type :</label>
                                    <asp:Label Width="100" ID="lblChargeType" runat="server" Font-Size="Small"></asp:Label>
                                    <br />

                                    <label class="lbltxt" style="width: 150px;">Rate :</label>
                                    <asp:Label Width="100" ID="lblRate" runat="server" Font-Size="Small"></asp:Label>
                                    <br />

                                    <label class="lbltxt" style="width: 150px;">From Date :  </label>
                                    <asp:Label Width="100" ID="lblFromDate" runat="server" Font-Size="Small"></asp:Label>
                                    <br />

                                    <label class="lbltxt" style="width: 150px;">Previous Balance : </label>
                                    <asp:Label Width="100" ID="lblPreviousBalance" runat="server" Font-Size="Small"></asp:Label>
                                    <br />
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <asp:Label ID="lblrateDes" runat="server" Text=""></asp:Label>
                                        </div>
                                    </div>
