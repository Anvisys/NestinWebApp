                            ...
                            <div class="col-sm-3 col-xs-12" style="text-align: center; margin-top: 15px;">
                                <div class="layout_shadow_box">
                                    <div class="show-image">
                                        <img id="uploadPreview" class="image_large" src="GetImages.ashx?UserID=<% =UserID %>&Name=<% =UserNameFirstLetter %>&UserType=<% =UserType %>" /><br />
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <table class="" style="border-collapse: collapse; color: #000; width: 100%; text-align: left;">
                                                ...
                                                <tr style="height: 30px;">
                                                    <td style="width: 40%;" class="auto-style1">Mobile :</td>
                                                    <td style="width: 55%;">
                                        ...
                                        <div class="col-sm-6">
                                            <table class="" style="border-collapse: collapse; color: #000; width: 100%; text-align: left;">
                                                ...
                                                <tr style="height: 30px;">
                                                    <td style="width: 40%;">Society Name:
                                                    </td>
                                                    <td style="width: 60%;">
                                ...
                                <div id="divSetting" class="layout_shadow_box container-fluid" style="padding: 20px; display: none;">
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-sm-4" style="text-align: left; padding-left: 10px; font-size: medium; color: rgb(51, 51, 51);">
                                            <label><b>Send Notifications on :</b></label>
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkComplaintNotice" Text=" Complaint Edit" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkForumNotice" Text=" Forum Update" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkBillingNotice" Text=" Bill Update" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="ChkNoticeNotification" Text=" Notification Update" />
                                            <br />
                                        ...
                                        <div class="col-sm-4" style="text-align: left; padding-left: 10px; font-size: medium; color: #000;">
                                            <label><b>Send Mails on : </b></label>
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkComplaintMail" Text=" Complaint Edit" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkForumMail" Text=" Forum Update" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkBillingMail" Text=" Bill Update" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkNoticeMail" Text=" Notification Update" />
                                            <br />
                                        ...
                                        <div class="col-sm-4" style="text-align: left; padding-left: 10px; font-size: medium; color: #000;">
                                            ...
                                            <asp:CheckBox runat="server" ID="chkComplaintSMS" Text=" Complaint Edit" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkForumSMS" Text=" Forum Update" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkBillingSMS" Text=" Bill Update" />
                                            <br />

                                            <asp:CheckBox runat="server" ID="chkNoticeSMS" Text=" Notification Update" />
                                            <br />
