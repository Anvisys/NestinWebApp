    ...
    <script>
            ...
            <body style="background-color: #f7f7f7">
                                            ...
                                            <div class="panel-body">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        <%--  <Legends>  
                                            <asp:Legend Alignment="Center" Docking="Left" IsTextAutoFit="False" Name="billLegend"  BackColor="#E74C3C" 
                                                LegendStyle="Column" />  
                                        </Legends>--%>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4" style="margin-top: 2px;">
                    <div class="panel panel-success myclass2" onclick="location.href='Discussions.aspx'" style="background-color: cadetblue; height: 178px; cursor: pointer; color: white;">
                        <div class="panel-heading">Discussion & Fourms</div>
                        <div class="panel-body">
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 60%;">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4" style="margin-top: 2px;">
                <div class="panel panel-success myclass2" onclick="location.href='Poll.aspx'" style="background-color: #E67E22; height: 195px; cursor: pointer; color: white;">
                    <div class="panel-heading">Opnion Polls</div>
                    <div class="panel-body">
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 60%;">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4" style="margin-top: 2px;">
                <div class="panel panel-success myclass2" onclick="#" style="background-color: #ffffff; height: 195px; cursor: pointer; color: white;">
                    <div class="panel-heading">Rent & share</div>
                    <div class="panel-body">
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 60%;">
