        ...
        <div class="container-fluid">
              <div class="row" style="margin-top:10px;">
                                     <div class="col-sm-3  col-xs-3" >
                                         <div><h4 class="pull-left ">Polls : </h4></div>
                                     </div>
                ...
                <div id="chart1-data" class=" col-xs-12 col-sm-6 col-md-6 ">
                    <div class="layout_shadow_box">
                        <div class="row">
                                 ...
                                 <asp:Label ID="lblQ1" runat="server" Height="50px" Font-Size="Medium"  ForeColor="#4A4A4A"></asp:Label> 
                            </div>
                         <div class="row">
                                <div class="col-xs-6" style="text-align:left;padding-left:25px;" >
                                   <asp:RadioButton ID="RadioChart1Opt1" runat="server" GroupName="RadioGroup1" onchange="RadioButtonCheck1(1)" ViewStateMode="enabled" Font-Size="Smaller"/>   <br />      
                                   <asp:RadioButton ID="RadioChart1Opt2" runat="server"  GroupName="RadioGroup1" onchange="RadioButtonCheck1(2)" ViewStateMode="enabled" Font-Size="Smaller" /><br />            
                                  </div>
                                <div class="col-xs-6" style="text-align:left;padding-left:25px;">
                                     <asp:RadioButton ID="RadioChart1Opt3" runat="server" GroupName="RadioGroup1" onchange="RadioButtonCheck1(3)" ViewStateMode="enabled" Font-Size="Smaller" /><br />                      
                                      <asp:RadioButton ID="RadioChart1Opt4" runat="server" GroupName="RadioGroup1" onchange="RadioButtonCheck1(4)"  ViewStateMode="enabled" Font-Size="Smaller" />
                      ...
                      <asp:Label ID="lblTotalVote1"  runat="server" Font-Size="Small" ForeColor="#0055AA"></asp:Label> <br />

                    
                                 <asp:Label ID="lblPie1date" runat="server"  Text="Started On :" Font-Size="Small" ForeColor="#0055AA"></asp:Label> <br />
                ...
                <div id="chart2-data" class="col-xs-12 col-sm-6 col-md-6 ">
                    <div class="layout_shadow_box">
                        <div class="row">
                            ...
                            <asp:Label ID="lblQ2" runat="server" Height="50px" Font-Size="Medium" ForeColor="#4A4A4A"></asp:Label>
                            </div>
                            <div class="row">
                                    <div class="col-xs-6" style="text-align:left; padding-left:25px;">
                                            <asp:RadioButton ID="RadioChart2Opt1" runat="server" GroupName="RadioGroup2" onchange="RadioButtonCheck2(5)" ViewStateMode="enabled" Font-Size="Smaller" /> <br />
                                             <asp:RadioButton ID="RadioChart2Opt2" runat="server" GroupName="RadioGroup2" onchange="RadioButtonCheck2(6)" ViewStateMode="enabled" Font-Size="Smaller" /><br />
                                               </div>

                                     <div class="col-xs-6" style="text-align:left;padding-left:25px;">
                                        <asp:RadioButton ID="RadioChart2Opt3" runat="server" GroupName="RadioGroup2" onchange="RadioButtonCheck2(7)" ViewStateMode="enabled" Font-Size="Smaller"/><br />
                                        <asp:RadioButton ID="RadioChart2Opt4" runat="server" GroupName="RadioGroup2" onchange="RadioButtonCheck2(8)" ViewStateMode="enabled" Font-Size="Smaller" />
                      ...
                      <asp:Label ID="lblTotalVote2"  runat="server" Font-Size="Small" ForeColor="#0055AA"></asp:Label>  <br />

                     <asp:Label ID="lblPie2Date" runat="server" Text="Started On :" Font-Size="Small" ForeColor="#0052A4"></asp:Label> <br />
                        </div>          
