                            ...
                            <li>  <a href="visitor.aspx" target="targetframe">Visitor</a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li style="margin-top:2px;"><a href="NewEmployee.aspx" target="targetframe">Employees</a></li>
                                                <li style="margin-top:2px;"><a href="Employees.aspx" target="targetframe">OldEmployees</a></li>
                                               <%-- <li style="margin-top:2px;"><a href="Flats.aspx" target="targetframe">Flats/Resident</a></li>--%>
                                                <li style="margin-top:2px;"><a href="NewFlats.aspx" target="targetframe">Flats/Resident</a></li>
                                          </ul>
                                        </li>
                                   <li class="dropdown">
