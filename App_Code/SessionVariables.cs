...
public class SessionVariables
{
    ...
    public static User EditUser
    {
        get
        {
            return (User)HttpContext.Current.Session["EditUser"];
        }
    ...
    public static int ServiceType
    {
        get
        {
            return (int)HttpContext.Current.Session["ServiceType"];
        }

        set
        {
            HttpContext.Current.Session["ServiceType"] = value;
        }
    }
    ...
    public static int SocietyID
    {
        get
        {
            return (int)HttpContext.Current.Session["SocietyID"];
        }

        set
        {
            HttpContext.Current.Session["SocietyID"] = value;
        }
    }
    ...
    public static int FlatID
    {
        get
        {
            return (int)HttpContext.Current.Session["FlatID"];
        }

        set
        {
            HttpContext.Current.Session["FlatID"] = value;
        }
    }
    ...
    public static String CurrentPage
    {
        get
        {
            return (String)HttpContext.Current.Session["CurrentPage"];
        }
