            ...
            else
            {
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    using (SqlConnection dbConnection = new SqlConnection(connString))
                    {
                        ...
                        var FlatNumber = this.FirstName.Substring(0, 1) + this.LastName.Substring(0, 1) + this.MobileNumber.Substring(7, 3);
                        var BHK = 3;
                        var Block = this.FirstName.Substring(0, 1);
                        var FlatArea = "1200";
                        var Floor = Convert.ToInt32(this.MobileNumber.Substring(9, 1));
                        var IntercomNumber = Convert.ToInt32(this.MobileNumber.Substring(5, 5));
                        var SocietyID = 1;
