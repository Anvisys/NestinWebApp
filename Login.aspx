            ...
            <div style="padding:0 1% 3% 1%;color:#6eab91; font-family:'Baskerville Old Face';font-size:x-large;">
              ...
              <h4 style="margin-bottom:0;"> 
                  <asp:Label ID="lblPasswordRes" runat="server" Text="" Font-Size="small" ForeColor="#000"></asp:Label></h4> 
                    ...
                    <asp:TextBox ID="TxtUserID" runat="server" CssClass="login_txtbox" placeholder="Email ID/MobileNumber"   BorderStyle="None"  TabIndex="1" ></asp:TextBox><br /><br />
...
<!-- WRAPPER -->
  ...
  <!-- PARALLAX -->
  <section class="parallax delayed margin-footer parallax-init" data-stellar-background-ratio="0.7"> <span class="overlay" style="background-color:#eee;"></span>
    <div class="container">
      <div class="row"> 
        <!-- left content -->
...
NestIn is our attempt to provide a state of the art, user friendly and secure Society Management System. We are good but not complacent, hence we are improving, enhancing the capabilities, taking the users feedback and working on them. Our dedicated team is working continuously to improve the system to better serve our customer.</p>
        ...
        <!-- right image -->
        <div class="col-md-5 animation_fade_in"> <img class="visible-md visible-lg img-responsive pull-right" src="Images/Icon/desktop2.png" alt="Society management System"/> </div>
      </div>
    </div>
  </section>
  <!-- PARALLAX -->
...
<!-- FOOTER -->
 <footer id="myFooter">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <h2 class="logo1"><img src="Images/Icon/iconHome.png" height="50" alt=""/></h2>
                </div>
                <div class="col-sm-2">
                    <h5>Get started</h5>
                    <ul>
