                            ...
                            <div id="myDIV" class="col-sm-6  col-xs-6" style="margin-top: 10px; text-align: center;">
                                ...
                                <ul class="nav nav-pills" style="margin: auto; width: 170px;">
                                    <li role="presentation" class="active">
                                        <asp:Button runat="server" CssClass="btn btn-sm" ID="showOpen" OnClick="showOpen_Click" Text="Open" CausesValidation="False" /></li>
                                    <li role="presentation">
                                        <asp:Button runat="server" CssClass="btn btn-sm" ID="showClose" OnClick="showClose_Click" Text="Close" CausesValidation="False" /></li>
                                    <li role="presentation">
                                        <asp:Button runat="server" CssClass="btn btn-sm" ID="showAll" OnClick="showAll_Click" Text="All" CausesValidation="False" /></li>
                                </ul>
                                    ...
                                    <table>
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <span style="float: right; padding-right: 25PX;">Characters Left :
                                                    <asp:Label ID="lblNotificationCount" runat="server" ForeColor="#999999" Text="250"></asp:Label>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input class="form-control" runat="server" type="date" id="ValidTill" name="validTill" /></label>
                                            </td>
                                        </tr>
