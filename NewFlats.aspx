                                                ...
                                                <div class="row layout_shadow_table ">
                                                        ...
                                                        <div class="col-sm-4 col-xs-6" style="border-left:solid 2px black;">
                                                            ...
                                                            <button id="btnRemove" class="btn-sm btn btn-success" 
                                                                onclick='<%#"RemoveOwner(" + Eval("OwnerResID")+",\""+ Eval("FlatNumber")+"\",\""+ Eval("Block") +"\","+ Eval("OwnerUserID")+",\""+ Eval("OwnerFirstName")+"\",\""+ Eval("OwnerLastName")+ "\")"%>' runat="server" type="button">Remove Owner</button>
                                                        <button id="btnAssign" class="btn-sm btn btn-warning" 
                                                            onclick='<%#"AssignOwner(" + Eval("ID") +",\""+ Eval("FlatNumber")+"\",\""+ Eval("BHK")+"\",\""+ Eval("FlatArea")+"\",\""+ Eval("Floor")+"\",\""+ Eval("Block")+ "\")"%>' runat="server" type="button">Assign Owner</button>
                             ...
                             <div class="panel panel-primary">
                                 ...
                                 <div class="panel-body">
                                     <div class ="row">
                                       ...
                                       <div class ="row">
                                         <div class="col-xs-6"><label>Name: </label> <label id="removeOwnerName"></label></div>
                             ...
                             <div class="panel panel-primary">
                                 ...
                                 <div class="panel-body">
                                     <div class ="row">
                                       ...
                                       <div class ="row">
                                         <div class="col-xs-6"><label>Name: </label> <label id="approveOwnerName"></label></div>
                                         <div class="col-xs-6"></div>
                                     </div>
                                       <div class ="row">
                                         <div class="col-xs-6"></div>
